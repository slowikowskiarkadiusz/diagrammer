...
export class AppComponent {
    ...
    constructor() {
        ...
        this.figures.push(new Circle("Warehouse Purchase Order Domain Service", new v2d(400, 550), 50, { fillColor: 'blue' }));
        this.figures[0].isFixed = false;
        this.figures[0].isDraggable = true;

        for (let i = 0; i < names.length; i++) {
            let figure = new Circle(processLabel(names[i]), new v2d(400, 50), 50, { fillColor: 'green' });
